...
window.FLOOD_DATA = {
  ...
  hist: [
    ...
    /* —— 2024-05-22 市防指《汛期城市积水点分布情况一览表》补点（2023 排查、工程整改中未销号）。已有 2026 事件/同路段的不重复堆点。H26 万象城保持用户补点编号。 —— */
    { n: "H29", cat: "road", district: "官渡", name: "官南大道（日新路至锦绣园段）", depth: "2024 一览表在册", note: "防指官渡第 2 条。锦苑花园/日新路口往南至锦绣园。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.997, lng: 102.718, r: 280 },
    { n: "H30", cat: "road", district: "官渡", name: "飞虎大道（福海路至春城路段）", depth: "2024 一览表在册", note: "防指官渡第 3 条。关上日新立交南侧、春城路以西。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.998, lng: 102.726, r: 240 },
    { n: "H31", cat: "road", district: "官渡", name: "金马路（东三环至凉亭/归十路）", depth: "2024 一览表在册", note: "防指官渡第 5/10/20 条（第 20 条「金码路」视为金马路笔误）。与牛街庄贵昆路、菊华立交相邻但路名不同。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.028, lng: 102.76, r: 320 },
    { n: "H32", cat: "road", district: "官渡", name: "永平路（北京路至前卫西路段）", depth: "2024 一览表在册", note: "防指官渡第 6 条。南坝/昆明站南，永平路口至前卫西路。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.012, lng: 102.708, r: 280 },
    { n: "H33", cat: "road", district: "官渡", name: "吴井路（民航路至环城南路段）", depth: "2024 一览表在册", note: "防指官渡第 7 条。吴井街道；与民航路长润街、环城南路万象城相邻，路名不同。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.0255, lng: 102.735, r: 220 },
    { n: "H34", cat: "road", district: "官渡", name: "拓东路（塘子巷至得胜桥段）", depth: "2024 一览表在册", note: "防指官渡第 8 条。北京路×拓东路往西至盘龙江得胜桥。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.0358, lng: 102.7152, r: 220 },
    { n: "H35", cat: "road", district: "官渡", name: "官渡2号路（雨龙路至彩云路段）", depth: "2024 一览表在册", note: "防指官渡第 9 条。小板桥雨龙路–彩云北路之间。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.986, lng: 102.762, r: 240 },
    { n: "H36", cat: "road", district: "官渡", name: "广福路（日新路/博康路至飞虎大道）", depth: "2024 一览表在册", note: "防指官渡第 12/15 条。比 7.16「云秀路至昌宏路」更靠西的广福路段。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.99, lng: 102.728, r: 280 },
    { n: "H37", cat: "road", district: "官渡", name: "国瑞路（春漫大道至石坝路段）", depth: "2024 一览表在册", note: "防指官渡第 13 条。阿拉/石坝片，与经开春漫大道衔接。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.005, lng: 102.801, r: 260 },
    { n: "H38", cat: "road", district: "官渡", name: "昌宏路（贵昆路至东三环段）", depth: "2024 一览表在册", note: "防指官渡第 18 条。昌宏路北段；南段广福–彩云已有 8.18 交叉口。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.024, lng: 102.763, r: 280 },
    { n: "H39", cat: "road", district: "官渡", name: "珥季路（金马路至贵昆路段）", depth: "2024 一览表在册", note: "防指官渡第 19 条。珥季路北段；南段大澡堂已有 8.18 缓行点。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.021, lng: 102.75, r: 260 },
    { n: "H40", cat: "road", district: "官渡", name: "星体路（星耀路至彩云路段）", depth: "2024 一览表在册", note: "防指官渡第 21 条。矣六/星耀路地铁站一带，彩云北路西侧短段。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.9605, lng: 102.765, r: 220 },
    { n: "H41", cat: "river", district: "官渡", name: "官南分干渠（南二环至日新路段）", depth: "2024 一览表在册", note: "防指官渡第 22 条。官南大道西侧渠段。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.0085, lng: 102.718, r: 280 },
    { n: "H42", cat: "road", district: "官渡", name: "云大西路（顺通大道至昆洛路段）", depth: "2024 一览表在册", note: "防指官渡第 23 条。与经开「云大西路昆玉桥洞」同廊、官渡段清单单独落点。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.976, lng: 102.784, r: 280 },
    { n: "H43", cat: "tunnel", district: "官渡", name: "机场高速（K3+100–K4+400段）", depth: "2024 一览表在册", note: "防指官渡第 24 条。东三环/大树营以东约 3–4 km 桩号段。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.046, lng: 102.798, r: 300 },
    { n: "H44", cat: "road", district: "官渡", name: "昆洛路（云大西路至彩云路段）", depth: "2024 一览表在册", note: "防指官渡第 25 条。矣六南、斗南以北。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.968, lng: 102.778, r: 280 },
    { n: "H45", cat: "new", district: "官渡", name: "矣六街道办事处门前", depth: "2024 一览表在册", note: "防指官渡第 26 条。地址商萃街/螺蛳湾二期一带。不是地图编号 26（那是吴井万象城）。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.957, lng: 102.776, r: 220 },
    { n: "H46", cat: "road", district: "五华", name: "普吉路（王家桥路口至二环北路段）", depth: "2024 一览表在册", note: "防指五华第 1 条。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.075, lng: 102.68, r: 280 },
    { n: "H47", cat: "road", district: "五华", name: "黑林铺街（海源中路至黑林铺派出所段）", depth: "2024 一览表在册", note: "防指五华第 3 条。与海源中路/戛纳小镇相邻。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.068, lng: 102.652, r: 240 },
    { n: "H48", cat: "road", district: "五华", name: "学府路（建设路至昆明理工大学段）", depth: "2024 一览表在册", note: "防指五华第 4 条。莲华/昆工一带。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.058, lng: 102.696, r: 240 },
    { n: "H49", cat: "tunnel", district: "五华", name: "昆武高速下层入城段（普吉路至西北三环）", depth: "2024 一览表在册", note: "防指五华第 6 条。下层入城，下穿高风险。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.076, lng: 102.668, r: 280 },
    { n: "H50", cat: "road", district: "盘龙", name: "穿金路（北二环至金绣路段）", depth: "2024 一览表在册", note: "防指盘龙第 1 条。穿金路地铁站以北至金殿/金绣路。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.07, lng: 102.735, r: 300 },
    { n: "H51", cat: "road", district: "盘龙", name: "北龙口（沣源路至龙泉路段）", depth: "2024 一览表在册", note: "防指盘龙第 2 条。北市区沣源–龙泉交叉带。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.086, lng: 102.726, r: 240 },
    { n: "H52", cat: "road", district: "盘龙", name: "沣源路（龙泉路至穿金路段）", depth: "2024 一览表在册", note: "防指盘龙第 3 条。与北龙口同片。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.085, lng: 102.732, r: 260 },
    { n: "H53", cat: "road", district: "西山", name: "西福路（广福路至二环南路段）", depth: "2024 一览表在册", note: "防指西山第 1 条。前卫/福海，广福路以北。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.0, lng: 102.7, r: 280 },
    { n: "H54", cat: "road", district: "西山", name: "日新路（二环西路至西福路段）", depth: "2024 一览表在册", note: "防指西山第 2 条。西山段日新路，不是官渡日新立交。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.003, lng: 102.692, r: 240 },
    { n: "H55", cat: "road", district: "西山", name: "海源南路（云山路至西山区政府段）", depth: "2024 一览表在册", note: "防指西山第 3 条。海源南路、区政府一带；海源中路已有 7.16 事件。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.04, lng: 102.658, r: 260 },
    { n: "H56", cat: "new", district: "呈贡", name: "锦绣大街（梁王路至彩云南路段）", depth: "2024 一览表在册", note: "防指呈贡第 1 条。呈贡新区主干，与 8.2 环湖东路金桂街不是同一段。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.848, lng: 102.842, r: 300 },
    { n: "H57", cat: "new", district: "呈贡", name: "梁王路（锦绣大街至春融街段）", depth: "2024 一览表在册", note: "防指呈贡第 2 条。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.852, lng: 102.838, r: 260 },
    { n: "H58", cat: "road", district: "经开", name: "顺通大道（云大西路至林溪路段）", depth: "2024 一览表在册", note: "防指经开第 2 条。昌宏西路林家围已有 7.16 点，本条补顺通大道。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.988, lng: 102.79, r: 280 },
    { n: "H59", cat: "road", district: "五华高新", name: "科医路（海源中路至科高路段）", depth: "2024 一览表在册", note: "防指高新区第 1 条。高新路网；海源中路已有 7.16 事件。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 25.056, lng: 102.662, r: 220 },
    { n: "H60", cat: "road", district: "西山", name: "红塔东路（滇池路至庄稼塘段）", depth: "2024 一览表在册", note: "防指滇池度假区第 1 条。海埂片，归西山分图。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.962, lng: 102.678, r: 260 },
    { n: "H61", cat: "road", district: "西山", name: "湖滨路（红塔东路至环湖东路段）", depth: "2024 一览表在册", note: "防指滇池度假区第 2 条。海埂湖滨。", source: "昆明市防汛抗旱指挥部办公室 2024-05-22", lat: 24.958, lng: 102.685, r: 240 }
  ]
};
